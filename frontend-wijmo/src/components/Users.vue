<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-title v-if="value._links">
            Users # {{value._links.self.href.split("/")[value._links.self.href.split("/").length - 1]}}
        </v-card-title >
        <v-card-title v-else>
            Users
        </v-card-title >
        ...
        <v-card-text>
            ...
            <String label="LoginId" v-model="value.loginId" :editMode="editMode"/>
            <String label="Pw" v-model="value.pw" :editMode="editMode"/>
            ...
            <DepartmentIdManager offline label="DepartmentId" v-model="value.departmentId" :editMode="editMode" @change="change"/>
        </v-card-text>
...
import UsersBase from '../components/UsersBase.vue'
...
export default {
    ...
    created(){
        ...
        websocketUrl.pathname = "/rsocket/users";
        websocketUrl.hash = "";
        ...
        client.connect().subscribe({
            ...
            const endpoint = "users."+ me.value.id +".get"
