<template>
    <div style="max-height:80vh;">
        ...
        <UsersViewQuery @search="search"></UsersViewQuery>
        ...
        >
            <wj-flex-grid-filter :filterColumns="['name','loginId','pw','isAdmin','phoneNumber','departmentId',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="departmentId[0].name" header="departmentId" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="name" header="name" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="loginId" header="loginId" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="pw" header="pw" width="2*" :isReadOnly="true" align="center" />
        ...
        <DepartmentIdDetailGrid :selectedGrid="selectedGrid" />
...
<script>
import UsersViewQuery from '../components/UsersViewQuery.vue';
import Users from '../components/Users.vue'
import DepartmentIdDetailGrid from './DepartmentIdDetailGrid.vue'
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.departmentId;
        ...
        async deleteSelectedRows() {
            try {
                if (!this.offline) {
                    ...
                    if (view.currentItem) {
                        const deleteUrl = view.currentItem._links.users.href;
